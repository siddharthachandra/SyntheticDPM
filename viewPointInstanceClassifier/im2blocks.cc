// greg, 14/3: This is an implementation of im2blocks that takes an image in pixels and a block size and averages the pixels per block
...
mxArray *process(const mxArray *mximage, const mxArray *mxsbin,const mxArray *mxout0,const mxArray *mxout1) {
  ...
  //const int *out = (int *)mxGetPr(mxout); //final feat dimensions 
